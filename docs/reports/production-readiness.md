...
| 2 | The core and all adapters pass automated tests | **Met** | 276 tests pass; 89 % line coverage of `fpr` + `fpr_gui` |
...
| Test | 276 tests across unit, integration, security and performance | All pass |
